...
function product3() {
  ...
  return (
    <div className='block py-10 lg:flex text-[#323232] md:h-auto lg:h-[600px]  gap-x-3 mx-auto items-center justify-center space-y-10 lg:space-y-0 px-4 lg:px-[50px]'>
